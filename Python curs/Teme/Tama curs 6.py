...
# reducere = int(input("procent reducere:"))
# pret = 359
# print(reducere_pret(pret))

# volum = 400
# print(reducere_pret(volum))

#
# 19. Functie care sa afiseze data si ora curenta din China
# def ora_china(time):
#     ora_china = time+6.00 # ora in China este cu 6 ore inainte fata de ora Romaniei
#     return ora_china
# time =float(input("Ora Romaniei"))
# print(ora_china(time))
...
# def zile_ramase(luna_nastere,data_nastere):
#     if luna_nastere>=luna_actuala:
#         zile_ramase = (luna_nastere * medie_zile_luna + ziua_nastere) - (luna_actuala * medie_zile_luna + ziua_actuala)
#     else:
#         zile_ramase = 365-(data_actuala)+data_nastere
#     return zile_ramase
# luna_nastere = float(input('luna nastere'))
# ziua_nastere = float(input('ziua nastere'))
# luna_actuala = float(input('luna actuala'))
# ziua_actuala= float(input('data actuala'))
# medie_zile_luna = 365/12
# data_nastere = luna_nastere*medie_zile_luna + ziua_nastere
# data_actuala = luna_actuala*medie_zile_luna+ ziua_actuala
# print(zile_ramase(luna_nastere,data_nastere))
