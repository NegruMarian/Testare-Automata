...
# lista_taguri = chrome.find_elements(By.TAG_NAME,
...
#     'n')  # * inseamna un inlocuitor pentru toate elementele care respecta regula
#
# sleep(2)
#
...
# chrome.find_element(By.XPATH, '//form//input[@id="first-name"]').send_keys(
#     'e')  # // = orice mostenitor, / = primul mostenitor
# sleep(2)
#
...
# sleep(1)
#
# select = Select(chrome.find_element(By.ID,'account_type'))
